...
import { NavigationLink, ApiResponse, SearchFilters, DashboardStats } from '@/lib/types';
...
export function useNavigation() {
  ...
  // Create new link
  const createLink = async (linkData: any): Promise<{ success: boolean; error?: string }> => {
    try {
  ...
  const updateLink = async (id: string, linkData: any): Promise<{ success: boolean; error?: string }> => {
    try {
